...
const Service = ({ icon, type, info }) => {
  return (
    <div className="relative z-20 box-border w-full rounded-lg border border-neutral-800 border-opacity-60 bg-neutral-900 bg-opacity-50 p-7 pt-10 sm:h-[235px] md:w-[calc(50%_-_20px)] md:flex-grow md:last:w-7/12 lg:w-[calc(33%_-_20px)_!important] ">
      <div>
